    ...
    <div className="space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        ...
        <div className="flex justify-end">
          <Link
            ...
            className="text-xs font-medium text-foreground/70 hover:text-foreground boty-transition"
          >
            Forgot password?
          </Link>
        </div>
      ...
      <div className="relative">
        ...
        <div className="relative flex justify-center text-xs">
          <span className="bg-transparent backdrop-blur-sm px-3 text-muted-foreground/70">
            Or sign in with
          </span>
        </div>
      </div>
      ...
      <div className="flex justify-center">
        <button
          type="button"
          className="w-14 h-11 rounded-xl border border-border/50 bg-muted/30 flex items-center justify-center hover:bg-muted/60 boty-transition"

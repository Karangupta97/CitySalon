                  ...
                  {salon.stylists.map((stylist) => (
                    <div key={stylist.id} className="group relative p-5 sm:p-6 rounded-2xl bg-card/70 border border-border/20 hover:border-primary/30 hover:shadow-lg boty-transition">
                      ...
                      {stylist.availability !== "off" && (
                        <Link href={`/salon/${salonId}/book`} className="mt-4 w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-full border border-border/40 text-xs font-medium text-foreground hover:bg-primary hover:text-primary-foreground hover:border-primary boty-transition">
                          <Calendar className="w-3.5 h-3.5" />
              ...
              <div className="animate-fade-in">
                ...
                {salon.beforeAfterGallery.length > 0 && (
                  <div className="mt-10">
                    ...
                    <h3 className="font-serif text-lg font-medium text-foreground mb-5">Before & After</h3>
